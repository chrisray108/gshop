...
module.exports = {
  mysql : {
    host: "rm-bp1svrzmg48wfs4z7563.mysql.rds.aliyuncs.com",
    port: 3306,
    user: "root",
    password: "root@Root",
    database: "mu_shop"
  ...
  session: {
    ...
    store: new redisStore({ host: 'r-bp1bf338dfea4904479.redis.rds.aliyuncs.com',pass:'rootcC123456', port: 6379, ttl : 600}),
